...
export const Players: Player[] = [
  {id: 1, name: 'Takenori Akagi', age: 18, team: 'Shohoku', stature: 193, average: 9.6, shirtNumber: 4, position: 'Pivot', foto:'logo.png', portrait:'/assets/logo.png', gallery:['assets/gallery/hanamichi1.png','assets/gallery/hanamichi2.png','assets/gallery/hanamichi3.png','assets/gallery/hanamichi4.png'], bio:'Capitán y pívot de Shohoku, conocido por su seriedad y disciplina. Sueña con llevar al equipo al campeonato nacional y es considerado el mejor pívot de la prefectura de Kanagawa.', skills: {fisico:10, tecnica:9, fuerzaMental:9,habilidadEspecial:10, resistencia:9} },
